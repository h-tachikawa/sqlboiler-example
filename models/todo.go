...
var (
	todoColumns               = []string{"id", "title", "note", "finished", "due_date", "user_id", "created_at", "updated_at"}
	todoColumnsWithoutDefault = []string{"title", "note", "finished", "user_id", "created_at", "updated_at"}
	todoColumnsWithDefault    = []string{"id", "due_date"}
...
func (o TodoSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("models: no Todo slice provided for delete all")
	}
